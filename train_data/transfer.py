...
# xml文件存放目录（不要以\结尾）
input_dir = r'G:\BaiduNetdiskDownload\PCB_DATASET\PCB_DATASET\Annotations\Spurious_copper'

# 输出txt文件目录（不要以\结尾）
out_dir = r'G:\python\yolov5-master\data\train_data\labels\train2024'
#类别名
class_list = ['spurious_copper']
